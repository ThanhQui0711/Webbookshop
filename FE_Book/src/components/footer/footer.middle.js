						...
						<div className="col-sm-3">
							<div className="single-widget">
								...
								<ul className="nav nav-pills nav-stacked ">
									<li><i className='fas fa-map-marker-alt'></i><a href="#">Thu Duc City</a></li>
									<li><i className='far fa-envelope'></i><a href="#">Qui@gmail.com</a></li>
									<li><i className='fas fa-phone-volume'></i><a href="#">+84 234 567 89</a></li>
									<li><i class="fab fa-facebook-f"></i><a href="#">Qui</a></li>
